...
export default async function AdminCreateRequisitionPage() {
    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#0b1326_0%,_#05070f_55%,_#020305_100%)] text-slate-100 md:grid md:grid-cols-[260px_1fr]">
      ...
      <main className="px-6 py-10 lg:px-10">
        <div>
          ...
          <h1 className="mt-3 text-2xl font-semibold">Create requisition</h1>
          <p className="mt-2 text-sm text-slate-400">
            Create a requisition and route it for approval.
          </p>
        </div>
